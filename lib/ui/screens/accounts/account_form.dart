...
class _AccountFormState extends State<AccountForm> {
  ...
  List<DropdownMenuItem<int?>> _buildParentAccountItems() {
    ...
    // Add the rest of the parent accounts
    for (var account in _parentAccounts) {
      // Skip the current account when editing to prevent circular references
      if (widget.account != null && account.id == widget.account!.id) {
        continue;
      }
      items.add(
        DropdownMenuItem(
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<int?>(
                  ...
                  value:
                      _isLoading || _parentAccounts.isEmpty
                          ? null
                          : _selectedParentId,
